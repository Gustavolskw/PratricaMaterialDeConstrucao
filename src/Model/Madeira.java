...
public class Madeira {
    String []descricao = {" é resultado de de uma única peça de madeira, sendo a opção mais resistente em comparação com outros tipos de madeira. ",
    ...
    String [] opcoes = {"Madeira maciça","Madeira laminada","Madeira tratada"};
    double[] precos= {399, 78, 80};
    int[] codigos = {88001, 88002, 88003};
