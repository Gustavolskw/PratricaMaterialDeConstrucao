	...
	public void exibeMenu() {
		...
		do {
			...
			case 3:
				...
				break;
			case 4:
				String infoEstoque = this.comercio.verProdutosEstoque();
				EntradaSaida.exibirProdutosEstoque(infoEstoque);
				break;
			case 5:
				if (comercio.getListaDeCupons().isEmpty()) {

					EntradaSaida.exibeMsgSemCupons();

				} else {

					String informacoes = this.comercio.verCuponsGerados();
					EntradaSaida.exibirCuponsCadastrados(informacoes);
				}
				break;
			case 6:
				if (comercio.getListaDeCupons().isEmpty()) {

					EntradaSaida.exibeMsgSemValorTotal();

				} else {

					String informacoes = this.comercio.calcularValorTotalCupons();
					EntradaSaida.exibirCuponsCalculados(informacoes);
				}
				break;
		...
		EntradaSaida.exibeMsgSairPrograma();
